...
function printFestivalSummary(festivalId, data) {
    ...
    console.log('\nSections:');
    festival.sectionsCache.forEach((section) => {
    ...
    if (sampleFilmId) {
        ...
        console.log(`Synopsis: ${film.synopsis.substring(0, 100)}...`);
...
function main() {
    console.log('Available Taipei Film Festivals:', Object.keys(festivalData));
    ...
    Object.keys(festivalData).forEach(festivalId => {
        ...
        Object.entries(festival.filmSectionsMap)
